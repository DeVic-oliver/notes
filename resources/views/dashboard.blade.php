...
@section('content')
    ...
    <main class="container-lg mt-8 mb-8 px-4">
        <h1 class="text-4xl text-center lg:text-start">Minha anotações</h1>
        ...
        @else
            <h2 class="mt-6 text-center text-lg lg:text-start">Você não tem anotações!</h2>    
        @endif
    </main>

    @if ((is_countable($warnings['warnings']) && count($warnings['warnings']) > 0))
        <aside class="container-lg px-4">
            <h3 class="text-2xl text-center lg:text-start mb-6">Últimos avisos da adm!</h3>
